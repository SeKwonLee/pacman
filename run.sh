...
do
    ...
    do
        ...
        sudo numactl --membind=0 --cpunodebind=0 ./ycsb_chameleondb 50331648 50331648 256 ${workload} ${nthreads} 4 &>> ../../../chameleondb_scale_results.txt
        printf "\n" &>> ../../../chameleondb_scale_results.txt
    done
done
